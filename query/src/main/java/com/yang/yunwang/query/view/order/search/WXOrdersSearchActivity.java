...
import com.yang.yunwang.query.api.presenter.WXPlantOrderPresenter;

@Route(path = IOrdersProvider.ORDERS_ACT_WX_PLANT)
public class WXOrdersSearchActivity extends BaseActivity implements WXPlantOrderContract.View, View.OnClickListener {
    ...
    private WXPlantOrderContract.Presenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitleText(R.string.wx_orders_search_title);
        new WXPlantOrderPresenter(this, this);
        init();
        initListener();
    }
    ...
    private void init() {
        ...
        code = intent.getStringExtra("wx_code");
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.image_scan) {
            ...
            intent_scan.put("flag_from", IOrdersProvider.ORDERS_ACT_WX_PLANT);
    ...
    @Override
    public void setPresenter(WXPlantOrderContract.Presenter presenter) {
