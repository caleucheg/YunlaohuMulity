package com.yang.yunwang.base.uncatchex;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void reLogin() {
        CommonShare.clear(mContext);
        JPUtils.cleanTags(mContext);
        CommonShare.putJPushIDBoolean(mContext, false);
            ...
            public void run() {
                ...
                if (stackElements != null) {
                    for (int i = 0; i < stackElements.length; i++) {
                        KLog.e(stackElements[i].getClassName() + "");
                        KLog.e(stackElements[i].getFileName() + "");
                        KLog.e(stackElements[i].getLineNumber() + "");
                        KLog.e(stackElements[i].getMethodName());
                        KLog.e("-----------------------------------");
                    }
                }
                Toast toast = Toast.makeText(mContext, "网络连接异常,请重新登录.",
                        Toast.LENGTH_LONG);
                toast.show();
                Looper.loop();
            }
